---
title: "UK IHT Treatment of Airdropped Tokens: Are Unexpectedly Received Crypto Assets Taxable"
description: "Airdropped tokens present a unique challenge for UK Inheritance Tax (IHT) planning. When a digital asset unexpectedly appears in a wallet—often as part of a …"
category: "UK"
pubDatetime: "2026-05-04T22:08:42Z"
publishDate: "2026-05-04T22:08:42Z"
modDatetime: "2026-06-14T05:33:02Z"
readingTime: 10
tags: ["featured"]
ogImage: "https://img.ukinheritance.com/跨境法务/UK继承/uk-iht-treatment-of-airdropped-tokens-are-unexpectedly-received-crypto-assets-ta-2026-1880x1111.jpg"
...
1. **Locate all wallets** – Use blockchain explorers (Etherscan, BscScan) to check the deceased’s known wallet addresses for any airdrop transactions. Many airdrops are visible on-chain even if the deceased never claimed them.
2. **Date-stamp the valuation** – Obtain a valuation report from a qualified crypto valuer as of the date of death, including screenshots of DEX prices or peer-to-peer sales.
3. **File the IHT400 accurately** – Declare each airdropped token separately, listing its name, quantity, and value. HMRC’s CRYPTO20080 (2024) recommends using the token’s contract address for identification.
4. **Consider a deed of variation** – If the estate exceeds the nil-rate band, beneficiaries may redirect airdropped tokens to a spouse or charity within two years of death to reduce the IHT bill (IHTA 1984, s. 142).
