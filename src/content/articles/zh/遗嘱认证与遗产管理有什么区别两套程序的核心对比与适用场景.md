---
title: "遗嘱认证与遗产管理有什么区别：两套程序的核心对比与适用场景"
description: "When a UK resident dies leaving assets valued at more than £10,000, the estate typically cannot be accessed or distributed until legal authority has been gra…"
category: "遗嘱认证与遗产管理有什么"
pubDatetime: "2026-02-25T21:54:15Z"
publishDate: "2026-02-25T21:54:15Z"
...
- **Who applies**: Executor named in the Will · Administrator (usually next of kin)
- **Court document**: Probate grant · Letters of administration
- **Will required**: Yes · No
- **Distribution rule**: Will terms · Intestacy rules (Administration of Estates Act 1925)
- **Number of applicants**: Up to 4 executors can act · Usually 1 or 2 administrators (max 4)
- **Time to grant**: 8–16 weeks (typical) · 10–20 weeks (often longer due to missing Will searches)
- **IHT form**: IHT400 (complex) or IHT205 (simple) · Same forms, but additional declarations may be needed
