---
title: "英国遗产税对域名投资的考量：高价值域名的遗产申报"
description: "In 2023–24, HM Revenue & Customs collected £7.5 billion in Inheritance Tax (IHT), a figure that has nearly doubled over the past decade, with the Office for …"
category: "英国遗产税对域名投资的考"
pubDatetime: "2026-03-21T21:59:20Z"
publishDate: "2026-03-21T21:59:20Z"
modDatetime: "2026-06-14T05:33:24Z"
readingTime: 3
tags: ["featured"]
...
1. **Locate the domains**: Check the deceased’s email accounts for renewal notices, registrar logins, and domain management platforms (e.g., GoDaddy, Namecheap, 123-reg). Use a WHOIS lookup tool to identify domains registered under the deceased’s name.
2. **Value the portfolio**: Obtain a written valuation from a recognised domain appraiser (e.g., Estibot, Sedo, or a specialist broker). For portfolios over £100,000, consider a formal appraisal report.
3. **Report to HMRC**: Use form IHT400 and the supplementary schedule IHT405 (intangible assets). Attach the valuation report and explain the methodology.
4. **Pay the tax**: IHT is due within six months of the end of the month of death. Late payment attracts interest at 7.75% (as of March 2025).
